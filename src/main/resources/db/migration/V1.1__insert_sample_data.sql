...
INSERT INTO menus 
(id, salon_id, menu_category_id, title, description, original_price, discounted_price, duration_minutes, item_type, tag, display_order, is_active) 
VALUES 
-- --- サロン1 (Carnet) のメニュー ---
-- カテゴリID:1 (脱毛) に紐付け

-- ID:1 [脱毛] 全身脱毛
(1, 1, 1, '全身脱毛（顔・VIO含む）', '最新マシンを使用した全身脱毛コースです。最短60分で完了します。', 
 22000, NULL, 60, 'MENU', '人気No.1', 1, true),

-- ID:2 [脱毛] VIOセット
(2, 1, 1, 'VIOセット脱毛', 'デリケートゾーンの3点セットです。痛みの少ない施術を心がけています。', 
...
-- ID:3 全身脱毛クーポン
(3, 2, 2, '【初回限定】お得クーポン☆全身脱毛', '顔全体/両腕/両脇/胸部/腹部/ヒップ/両脚/背中全体/VIOを全て施術します', 
 28000, 22000, 90, 'COUPON', '新規のみ', 1, true),

-- ID:4 選べる5か所クーポン
(4, 2, 2, '【初回限定】自由に選べる5か所脱毛', 'ご希望の施術部位を5ヵ所お選び下さい（顔全体/両腕/両脇 など）', 
...
-- ID:5 VIOセット
(5, 2, 2, 'VIOセット ～令和の新常識～', '人気のVIOセットコースです。', 
 6000, NULL, 45, 'MENU', NULL, 10, true),

-- ID:6 Vライン
(6, 2, 2, 'Vライン ～令和の新常識～', NULL, 
 3000, NULL, 30, 'MENU', NULL, 11, true),

-- ID:7 Iライン
(7, 2, 2, 'Iライン ～令和の新常識～', NULL, 
 3000, NULL, 30, 'MENU', NULL, 12, true),

-- ID:8 Oライン
(8, 2, 2, 'Oライン ～令和の新常識～', NULL, 
 3000, NULL, 30, 'MENU', NULL, 13, true),

-- ID:9 男性ヒゲ
(9, 2, 2, '男性ヒゲセット ～毎朝の髭剃りとおさらば～', '男性のお客様限定。毎朝の処理が楽になります。', 
...
-- ID:10 120分
(10, 2, 3, 'アロマリンパマッサージ 120分', 'たっぷりと時間をかけて全身の疲れを癒やします。', 
 17000, NULL, 120, 'MENU', NULL, 20, true),

-- ID:11 90分
(11, 2, 3, 'アロマリンパマッサージ 90分', 'スタンダードな90分コースです。', 
 13000, NULL, 90, 'MENU', NULL, 21, true),

-- ID:12 60分
(12, 2, 3, 'アロマリンパマッサージ 60分', 'お試しや時間のあいた時に最適な60分コース。', 

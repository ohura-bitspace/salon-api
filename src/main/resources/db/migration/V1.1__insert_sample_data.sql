...
-- サロン2 (salon-up-s)
(2, 2, '脱毛', 1),
(3, 3, 'アロマリンパマッサージ～心地よい香りでリラックス', 2),
(4, 3, 'スクラブトリートメント～角質を落として全身美肌', 1),
(5, 3, 'スタンダード', 2),
(6, 3, 'ショート', 3);
...
(10, 2, 2, 2, '鼻下 ～毎朝の髭剃りとおさらば～', '男性のお客様限定。毎朝の処理が楽になります。', 
 2000, NULL, 20, 'MENU', 'メンズ', 15, true),
(11, 2, 2, 2, 'アゴ ～毎朝の髭剃りとおさらば～', '男性のお客様限定。毎朝の処理が楽になります。', 
 2000, NULL, 20, 'MENU', 'メンズ', 16, true),
(12, 2, 2, 2, 'ほほ ～毎朝の髭剃りとおさらば～', '男性のお客様限定。毎朝の処理が楽になります。', 
 2000, NULL, 20, 'MENU', 'メンズ', 17, true),
(13, 2, 2, 2, '首周り ～毎朝の髭剃りとおさらば～', '男性のお客様限定。毎朝の処理が楽になります。', 
 2000, NULL, 20, 'MENU', NULL, 18, true),
(14, 2, 2, 2, '首周り ～毎朝の髭剃りとおさらば～', '男性のお客様限定。毎朝の処理が楽になります。', 
 2000, NULL, 20, 'MENU', NULL, 19, true),
(15, 2, 2, 2, '両脚 ～憧れのすっきり美脚～', NULL, 
 2000, NULL, 20, 'MENU', NULL, 20, true),
 

-- ▼ アロマメニュー
-- カテゴリID:3 (アロマ) に紐付け
-- ID:10 120分
(16, 2, 3, 3, 'アロマリンパマッサージ 120分', 'たっぷりと時間をかけて全身の疲れを癒やします。', 
 17000, NULL, 120, 'MENU', NULL, 21, true),

-- ID:11 90分
(17, 2, 3, 3, 'アロマリンパマッサージ 90分', 'スタンダードな90分コースです。', 
 13000, NULL, 90, 'MENU', NULL, 22, true),

-- ID:12 60分
(18, 2, 3, 3, 'アロマリンパマッサージ 60分', 'お試しや時間のあいた時に最適な60分コース。', 

...
(14, 2, 2, 2, '首周り ～毎朝の髭剃りとおさらば～', NULL, 
 2000, NULL, 20, 'MENU', NULL, 19, true),
(15, 2, 2, 2, '両脚 ～憧れのすっきり美脚～', NULL, 
 5000, NULL, 30, 'MENU', NULL, 20, true),
(16, 2, 2, 2, '背中 ～美しさは後ろ姿から～', NULL, 
 5000, NULL, 30, 'MENU', NULL, 21, true),
(17, 2, 2, 2, '女性顔全体 ～化粧のノリが段違い～', NULL, 
 4000, NULL, 30, 'MENU', NULL, 22, true),
(18, 2, 2, 2, '両腕 ～肩から指先までキレイに～', NULL, 
 4000, NULL, 30, 'MENU', NULL, 23, true),
(19, 2, 2, 2, 'ヒップ ～触りたくなるすべすべ美尻に～', NULL, 
 4000, NULL, 30, 'MENU', NULL, 24, true),

-- ▼ アロマメニュー
-- カテゴリID:3 (アロマ) に紐付け
-- ID:10 120分
(21, 2, 3, 3, 'アロマリンパマッサージ 120分', 'たっぷりと時間をかけて全身の疲れを癒やします。', 
 17000, NULL, 120, 'MENU', NULL, 21, true),

-- ID:11 90分
(22, 2, 3, 3, 'アロマリンパマッサージ 90分', 'スタンダードな90分コースです。', 
 13000, NULL, 90, 'MENU', NULL, 22, true),

-- ID:12 60分
(23, 2, 3, 3, 'アロマリンパマッサージ 60分', 'お試しや時間のあいた時に最適な60分コース。', 
